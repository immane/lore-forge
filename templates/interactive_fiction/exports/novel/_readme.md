...
- **Outline Export** — chapter, branch, node, or state outline adapted for prose drafting
...
1. Source: `story/branches/`, `events/`, `characters/`, `dialogue/`, `locations/`, `memories/`, `knowledge/`
