...
Lore Forge is a pure Markdown framework. It needs three capabilities from your AI platform:
...
Paste this prompt and your agent will detect the platform and install the required MCPs automatically:

```
Read REQUIREMENT.md. Detect which AI platform you are running on.
Set up the minimum required MCP servers for this platform by creating or editing the correct config file.
...
If you prefer to set up manually, follow the instructions for your platform below.
...
File I/O is native. Content search is native. Memory and web search need MCP.
